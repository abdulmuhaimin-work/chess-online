...
(function() {
    ...
    function Q(f) {
        ...
        for (var b = 0; 8 > b; b++)
            if ("" === f[b] || 8 < f[b].length || -1 !== f[b].search(/[^kqrbnpKQRNBP1-8]/)) return !1;
        return !0
    }
    ...
    function K(f) {
        ...
        for (var b = {}, n = 8, m = 0; 8 > m; m++) {
            for (var l = f[m].split(""), r = 0, w = 0; w < l.length; w++)
                if (-1 !== l[w].search(/[1-8]/)) var I = parseInt(l[w], 10),
                    r = r + I;
                else {
                    var I = b,
                        F = B[r] + n,
    ...
    function L(f) {
        ...
        for (var b = "", n = 8, m = 0; 8 > m; m++) {
            for (var l = 0; 8 > l; l++) {
                var r = B[l] + n;
                !0 === f.hasOwnProperty(r) ? (r = f[r].split(""), r = "w" === r[0] ? r[1].toUpperCase() :
                    r[1].toLowerCase(), b += r) : b += "1"
            }
            7 !== m && (b += "/");
            n--
        }
    ...
    window.ChessBoard = window.ChessBoard || function(f, b) {
        function n() {
        ...
        function r(a, e, c) {
            if (!0 === b.hasOwnProperty("showErrors") && !1 !== b.showErrors) {
                ...
                "console" === b.showErrors && "object" === typeof console && "function" === typeof console.log ? (console.log(d), 2 <= arguments.length && console.log(c)) : "alert" === b.showErrors ? (c && (d += "\n\n" + JSON.stringify(c)), window.alert(d)) : "function" === typeof b.showErrors && b.showErrors(a, e, c)
            }
        }

        function w(a) {
            return "fast" ===
                a || "slow" === a ? !0 : parseInt(a, 10) + "" !== a + "" ? !1 : 0 <= a
        }
        ...
        function D(a, b, c) {
            ...
            d += 'alt="" class="' +
                h.piece + '" data-piece="' + a + '" style="width: ' + p + "px;height: " + p + "px;";
            !0 === b && (d += "display:none;");
            return d + '" />'
        }
        ...
        function ja(a, e, c) {
            function d() {
                f++;
                if (f === a.length && (G(), !0 === b.hasOwnProperty("onMoveEnd") &&
                        "function" === typeof b.onMoveEnd)) b.onMoveEnd(m(e), m(c))
            }
            for (var f = 0, g = 0; g < a.length; g++) "clear" === a[g].type && $("#" + s[a[g].square] + " ." + h.piece).fadeOut(b.trashSpeed, d), "add" === a[g].type && !0 !== b.sparePieces && $("#" + s[a[g].square]).append(D(a[g].piece, !0)).find("." + h.piece).fadeIn(b.appearSpeed, d), "add" === a[g].type && !0 === b.sparePieces && ia(a[g].piece, a[g].square, d), "move" === a[g].type && ha(a[g].source, a[g].destination, a[g].piece, d)
        }
        ...
        function G() {
            ...
            for (var a in g) !0 === g.hasOwnProperty(a) && $("#" + s[a]).append(D(g[a]))
        }

        function R() {
            x.html(A(u));
            G();
            !0 === b.sparePieces && ("white" ===
                u ? (S.html(N("black")), T.html(N("white"))) : (S.html(N("white")), T.html(N("black"))))
        }
        ...
        function na(a) {
            ...
            y.animate(e, {
                ...
                complete: function() {
                    G();
                    y.css("display", "none");
                    if (!0 === b.hasOwnProperty("onSnapEnd") && "function" ===
                        typeof b.onSnapEnd) b.onSnapEnd(t, a, E)
                }
            });
            z = !1
        }
        ...
        function P(a, e, c, d) {
            if ("function" !== typeof b.onDragStart || !1 !== b.onDragStart(a, e, m(g), u)) {
                ...
                "spare" !== a && $("#" + s[a]).addClass(h.highlight1).find("." + h.piece).css("display", "none")
            }
        }
        ...
        function ua(a) {
            !0 === z && (a = U(a.originalEvent.changedTouches[0].pageX,
                a.originalEvent.changedTouches[0].pageY), ba(a))
        }
        ...
        function xa() {
            ...
            !0 === (navigator && navigator.userAgent && -1 !== navigator.userAgent.search(/MSIE/)) ? (document.ondragstart = function() {
                return !1
            }, $("body").on("mousemove", ca), $("body").on("mouseup", da)) : ($(window).on("mousemove", ca), $(window).on("mouseup", da));
            !0 === "ontouchstart" in
                document.documentElement && (x.on("touchstart", "." + h.square, qa), v.on("touchstart", "." + h.sparePieces + " ." + h.piece, sa), $(window).on("touchmove", ta), $(window).on("touchend", ua))
        }
        ...
        q.move = function() {
            if (0 !== arguments.length) {
                ...
                var c = g,
                    c = m(c),
                    f;
                for (f in b) !0 === b.hasOwnProperty(f) && !0 ===
                    c.hasOwnProperty(f) && (d = c[f], delete c[f], c[b[f]] = d);
                b = c;
                q.position(b, a);
                return b
            }
        ...
        q.position = function(a, b) {
            ...
            !0 === Q(a) && (a = K(a));
            if (!0 !==
                F(a)) r(6482, "Invalid value passed to the position method.", a);
            else if (!0 === b) {
                var c = g,
                    d = a,
                    c = m(c),
                ...
                for (k in d)
                    if (!0 === d.hasOwnProperty(k)) {
                        ...
                        a: {
                            ...
                            destination: k,
                            piece: d[k]
                        }), delete c[l], delete d[k], h[k] = !0)
                    }
                for (k in d) !0 === d.hasOwnProperty(k) &&
                    (f.push({
                        type: "add",
                        square: k,
                        piece: d[k]
                    }), delete d[k]);
                for (k in c) !0 === c.hasOwnProperty(k) && !0 !== h.hasOwnProperty(k) && (f.push({
                    type: "clear",
                    square: k,
                    piece: c[k]
                }), delete c[k]);
        ...
        if (W = !0 ===
            function() {
                ...
                if (a = typeof window.$)
                    if (a = $.fn)
                        if (a = $.fn.jquery) var a = $.fn.jquery,
                            b = "1.7.0",
                            a = X(a),
                            b = X(b),
            ...
            if (!0 !== b.hasOwnProperty("pieceTheme") || "string" !== typeof b.pieceTheme && "function" !== typeof b.pieceTheme) b.pieceTheme = "assets/chesspieces/wikipedia/{piece}.png";
            if (!0 !== b.hasOwnProperty("appearSpeed") ||
                !0 !== w(b.appearSpeed)) b.appearSpeed = 200;
            if (!0 !== b.hasOwnProperty("moveSpeed") || !0 !== w(b.moveSpeed)) b.moveSpeed = 200;
            ...
            !0 === b.hasOwnProperty("position") && ("start" === b.position ? g = m(fa) : !0 === Q(b.position) ? g = K(b.position) : !0 === F(b.position) ? g = m(b.position) : r(7263, "Invalid value passed to config.position.",
                b.position));
            W = !0
        }
        W && (I(), ya(), xa());
